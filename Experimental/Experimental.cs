...
//....\......................./´..... 
//......\................ ..(........
#warning experimental code in this method.
...
namespace forexAI
{
	static public class Experimental
	{
		...
		static public void AlliedInstructions()
		{
			...
			else if (random.Next(Configuration.experimentalAlliedRandomUpperBound) == 4384)
				console("дяя", ConsoleColor.Black, ConsoleColor.Yellow);
		...
		{
			if (random.Next(Configuration.experimentalAlliedRandomUpperBound)
				== random.Next(Configuration.experimentalAlliedRandomUpperBound))
			{
				console($"bLACK HATE CHECKPOINt +---{random.Next(Configuration.experimentalAlliedRandomUpperBound)} " +
					$"{random.Next(Configuration.experimentalAlliedRandomUpperBound)} {random.Next(Configuration.experimentalAlliedRandomUpperBound)}" +
					$"{random.Next(Configuration.experimentalAlliedRandomUpperBound)} {random.Next(Configuration.experimentalAlliedRandomUpperBound)} " +
					$"{random.Next(Configuration.experimentalAlliedRandomUpperBound)}---+", ConsoleColor.Yellow, ConsoleColor.Red);
				forexAI.AudioFX.TheBroken();
				return true;
			}
			return false;
		}
